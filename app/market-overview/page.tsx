...
export default function MarketOverviewPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Banner/Hero Section */}
      <div className="relative bg-gradient-to-r from-teal-900 to-teal-800 py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl relative z-20">
            ...
            >
              ...
              >
                <span className="px-3 py-1.5 bg-orange-500/20 text-orange-300 rounded-full text-xs font-medium">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-white leading-tight">
                ...
                <span className="text-orange-400 relative">
                  Market Overview
                  <motion.div
                    className="absolute -bottom-1 left-0 h-0.5 bg-orange-500/50 rounded-full"
                    initial={{ width: 0 }}
                    animate={{ width: "100%" }}
              ...
              <p className="text-lg text-teal-50/90 leading-relaxed max-w-2xl">
