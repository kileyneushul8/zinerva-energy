...
import { Lock, Shield, Eye, FileText, AlertCircle } from "lucide-react"
...
const sections = [
    {
        ...
        content: [
            "Personal identification information (Name, email, company details)",
    ...
    },
    {
        ...
        content: [
            ...
            "Market analysis and trading optimization"
        ]
    },
    {
        icon: FileText,
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-teal-600">
                                            This Privacy Policy describes how Zinerva Energy collects, uses, and protects
                                            your personal information. We are committed to maintaining the trust and
                                            confidence of our clients while delivering exceptional energy trading services.
                                        </p>
                                    </div>
                                </div>
                            </CardContent>
              ...
              rounded-xl border border-teal-100"
                    >
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-lg font-semibold text-teal-900 mb-2">Questions About Privacy?</h3>
                                <p className="text-teal-600">
